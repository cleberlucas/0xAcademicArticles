...
library MessageLib {
    ...
    string public constant ONE_OF_ARTICLES_ALREADY_EXIST = "one-of-articles-already-published";
    string public constant ONE_OF_ARTICLES_WAS_NOT_EXIST = "one-of-articles-was-not-published";
    ...
    string public constant ONE_OF_AFFILIATES_WAS_NOT_EXIST = "one-of-affiliates-was-not-registered";
    string public constant ONE_OF_AFFILIATES_ALREADY_EXIST= "one-of-affiliates-already-registered";
    string public constant ONE_OF_INSTITUTIONS_WAS_NOT_EXIST = "one-of-institutionswas-not-registered";
    string public constant ONE_OF_INSTITUTIONS_ALREADY_EXIST= "one-of-institutions-already-registered";
